  ...
  return {
    fullHead: `
      ...
      <script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"${domain}/#organization","name":"${siteTitle}","url":"${domain}/","sameAs":[${social.join(
        ', '
      )}],"logo":{"@type":"ImageObject","@id":"${domain}/#logo","inLanguage":"en-US","url":"${siteLogo}","contentUrl":"${siteLogo}","width":173,"height":60,"caption":"${siteTitle}"},"image":{"@id":"${domain}/#logo"}},{"@type":"WebSite","@id":"${domain}/#website","url":"${domain}/","name":"${siteTitle}","description":"${seo?.generalSettings?.description || ''
      }","publisher":{"@id":"${domain}/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"${domain}/search?q={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":["CollectionPage"${path === 'search' && ',"SearchResultsPage"'
