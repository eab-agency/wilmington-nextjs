...
import queryEventsListingAttributes, { queryEventsCategoryAttributes } from '@/lib/wordpress/events-listing/queryEventsListingAttributes';
...
export default async function getEventsListingData(ids, category) {
    ...
    if (category) {
        ...
        const result = await apolloClient
            ...
            .then((result) => {
                const eventsInCategory = result?.data?.eventCategory?.events?.nodes || [];
