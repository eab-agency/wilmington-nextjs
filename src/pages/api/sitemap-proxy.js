...
const WORDPRESS_URL = process.env.NEXT_PUBLIC_WORDPRESS_URL // e.g. 'https://my-wordpressdomain.com'
const FRONTEND_URL = process.env.SITE_URL // e.g. 'https://localhost:3000'
