...
export default function ChildrenPrograms({ programs, parentSlug }: ChildrenProgramsProps) {
  ...
  const programsWithAncestorFiltered = programsWithAncestor.filter((program) => {
