...
export default function wordpressLoader({ src, quality, width }) {
    console.log("🩸🩸🩸🩸🩸🩸 ~ file: imageLoader.js:8 ~ wordpressLoader ~ width:", width)
    console.log("🩸🩸🩸🩸🩸🩸 ~ file: imageLoader.js:8 ~ wordpressLoader ~ quality:", quality)
    console.log("🩸🩸🩸🩸🩸🩸 ~ file: imageLoader.js:8 ~ wordpressLoader ~ src:", src)
